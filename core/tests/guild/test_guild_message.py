...
class TestGuildMessages:
    ...
    def test_messages_with_reason(self, messaging: MessagingConfig, database, org_id):
        agent_name = "Accountable Agent"
        agent_description = "Agent that provides accountability by sending messages with a reason"
        ...
        builder = GuildBuilder(
            guild_name="test_guild_accountability", guild_description="guild to test accountability"
        ).set_messaging(
            messaging.backend_module,
            messaging.backend_class,
            messaging.backend_config,
        ...
        rule1 = (
            RouteBuilder(agent_spec)
            .from_method("custom_handler")
        ...
        probe_spec = (
            ...
            .set_name("ProbeAgent")
            .set_description("A probe agent")
            .add_additional_topic(UserProxyAgent.get_user_outbox_topic("test_user"))
            .build_spec()
        )
