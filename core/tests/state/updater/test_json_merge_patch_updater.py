...
from rustic_ai.core.state.updater.json_merge_patch_updater import JsonMergePatchUpdater


class TestJsonMergePatchUpdater:
    @pytest.fixture
    ...
    def test_apply_update(self, state: JsonDict, update: JsonDict, updated_state: JsonDict):
        assert JsonMergePatchUpdater.apply_update(state, update) == updated_state
