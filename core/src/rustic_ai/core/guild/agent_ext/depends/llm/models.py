...
class ChatCompletionRequest(LLMBaseModel):
    ...
    Set in either of the two ways, guarantees the message the model generates is valid JSON.
    response_format=<valid_json_schema_dict>
    response_format="my.org.pydantic_model"
